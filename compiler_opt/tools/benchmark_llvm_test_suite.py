...
flags.DEFINE_string("output_path", "", "The path to an output file in JSON format")
flags.DEFINE_string("perf_counters", "", "A list of comma separated performance counters in the libpfm format")
...
def main(argv):
  ...
  for test in FLAGS.tests_to_run:
    completed_benchmarks.extend(benchmarking_utils.run_microbenchmark(test, FLAGS.perf_counters))
